...
The documentation is automatically generated by Swagger and is located at `/api/v1/swagger-ui.html`. A running demo version is up on AWS at http://ec2-35-163-102-162.us-west-2.compute.amazonaws.com:8080/api/v1/swagger-ui.html
